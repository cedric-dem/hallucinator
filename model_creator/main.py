...
DATA_DIR: str = "v5/data/"             # Directory with training JPGs
INPUT_IMAGE: str = "v5/_img_in.jpg"     # Image to encode/decode
OUTPUT_IMAGE: str = "v5/output.jpg"   # Where to save the reconstruction
