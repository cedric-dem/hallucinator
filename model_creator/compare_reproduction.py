...
ENCODER_MODEL_PATH = Path("results/new_medium_small_model/models/epoch_0120/model_encoder.keras")
DECODER_MODEL_PATH = Path("results/new_medium_small_model/models/epoch_0120/model_decoder.keras")
